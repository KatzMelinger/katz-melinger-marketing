    ...
    >
      ...
      <section className="grid gap-4 sm:grid-cols-4">
        ...
        <article className="rounded-xl border border-[#e2e8f0] bg-white p-4">
          ...
          <Link href="/seo/competitors" className="mt-1 inline-block text-[11px] text-[#185FA5] hover:underline">
            Manage competitors →
          </Link>
        </article>
      </section>
      ...
      <section className="rounded-xl border border-[#e2e8f0] bg-white p-5">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={refresh}
            disabled={loading}
            className="rounded-md border border-[#185FA5] px-3 py-2 text-sm font-medium text-[#185FA5] hover:bg-[#185FA5]/5 disabled:opacity-50"
          >
