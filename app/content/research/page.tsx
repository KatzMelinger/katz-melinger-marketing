    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Curate real audience questions, then run the Research Layer to
          assemble a packet that feeds SEO content. The Legal Authority Library
          now lives under{" "}
          <Link href="/brand-voice" className="font-medium text-slate-900 hover:underline">
            Content Standards
          </Link>
          .
        </p>
