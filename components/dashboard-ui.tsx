...
export function DashInput(
  ...
  return (
    <input
      {...rest}
      className={`px-3 py-2 rounded-md border border-slate-300 bg-white text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#185FA5]/30 focus:border-[#185FA5] ${className}`}
    />
  );
}
...
export function DashSelect(
  ...
  return (
    <select
      {...rest}
      className={`px-3 py-2 rounded-md border border-slate-300 bg-white text-sm text-white focus:outline-none focus:ring-2 focus:ring-[#185FA5]/30 focus:border-[#185FA5] ${className}`}
    >
      {children}
    </select>
  );
