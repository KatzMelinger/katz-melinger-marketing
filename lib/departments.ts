...
export const DEPARTMENTS: Department[] = [
  {
    ...
    items: [
      ...
      { label: "Briefs", href: "/content/briefs", icon: "📋", status: "phase2" },
      { label: "Production Board", href: "/content/pipeline", icon: "▥", status: "active" },
      { label: "Publishing QA", href: "/content/publishing-qa", icon: "🔍", status: "phase2" },
      { label: "Refresh Queue", href: "/content/refresh", icon: "♻", status: "phase2" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Competitor Gaps", href: "/seo/competitor-gaps", icon: "▱", status: "phase2" },
      { label: "PR Pitches", href: "/seo/pr-pitches", icon: "📰", status: "active" },
      { label: "Legal Directories", href: "/seo/directories", icon: "⚖", status: "phase2" },
      { label: "Citations", href: "/seo/citations", icon: "📎", status: "phase2" },
    ],
  },
  {
    key: "ai-visibility",
