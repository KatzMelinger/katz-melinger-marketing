...
-- ============================================================================
-- Multi-tenancy — Phase 4: tenant-scoped RLS for the Content core.
-- content_drafts / content_analyses / content_batches / content_pipeline are all
-- id-keyed, so RLS flip only. The generation libs (content-multiformat,
-- content-analysis, title-cannibalization) stamp/scope by tenant; routes use the
-- tenant client. Idempotent.
-- ============================================================================
do $$
declare t text; p text;
begin
  foreach t in array array['content_drafts','content_analyses','content_batches','content_pipeline'] loop
